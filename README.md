...
| [`:permissions`](permissions) | `com.coderwise.libs:permissions` | `0.4.0` | Runtime permission state (location, camera, Bluetooth, notifications) for Compose Multiplatform. |
