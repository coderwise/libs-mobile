...
| [`:permissions`](permissions) | `com.coderwise.libs:permissions` | `0.3.2` | Runtime permission state (location, camera, Bluetooth, notifications) for Compose Multiplatform. |
| [`:database`](database) | `com.coderwise.libs:database` | `0.1.0` | SQLDelight driver factory + Koin DI. |
| [`:location`](location) | `com.coderwise.libs:location` | `0.1.0` | GPS location provider (current location + updates `Flow`). |
