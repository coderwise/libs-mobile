...
kotlin {
    android {
        namespace = "com.coderwise.libs.experiment.map.tiles"
    ...
    sourceSets {
        commonMain.dependencies {
            api(project(":experiment-map-engine"))
...
mavenPublishing {
    ...
    pom {
        name.set("Coderwise Map Tiles (experiment)")
        description.set("Experimental tile loading for com.coderwise.libs:experiment-map-engine: a queue that fills a MapState nearest-the-centre first, and the rule for what a slot shows while its own tile is still coming.")
