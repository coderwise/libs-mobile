...
kotlin {
    android {
        namespace = "com.coderwise.libs.experiment.map.tiles.vector"
...
mavenPublishing {
    ...
    pom {
        name.set("Coderwise Map Tiles, vector (experiment)")
        description.set("Experimental vector tile slot: a hand-rolled Mapbox Vector Tile decoder, a redefinable style, and place and road labels as text composables. Depends on nothing but Compose.")
