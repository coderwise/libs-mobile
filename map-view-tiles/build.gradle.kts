...
kotlin {
    android {
        namespace = "com.coderwise.libs.mapview.tiles"
...
mavenPublishing {
    ...
    pom {
        name.set("Coderwise Map View Tiles")
        description.set("Tile loading for com.coderwise.libs:map-view: a queue that fills a MapState nearest-the-centre first, and the rule for what a slot shows while its own tile is still coming.")
