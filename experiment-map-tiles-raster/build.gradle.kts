...
kotlin {
    android {
        namespace = "com.coderwise.libs.experiment.map.tiles.raster"
...
mavenPublishing {
    ...
    pom {
        name.set("Coderwise Map Tiles, raster (experiment)")
        description.set("Experimental raster tile slot: draws the visible fraction of an ImageBitmap. Depends on nothing but Compose.")
